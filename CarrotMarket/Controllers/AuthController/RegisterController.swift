...
class RegisterViewContoller: UIViewController {
    ...
    let inputPhoneNumberField: UITextField = {
        ...
        tf.attributedPlaceholder = NSAttributedString(string: "휴대폰 번호(- 없이 숫자만 입력)", attributes: [.foregroundColor: UIColor(hex: "6D707A")])
        tf.textColor = .white
...
extension RegisterViewContoller: UITextFieldDelegate {
