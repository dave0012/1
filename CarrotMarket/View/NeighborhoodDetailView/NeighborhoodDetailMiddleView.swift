...
class NeighborhoodDetailMiddleView: UIView {
    ...
    let numberCuriousAndCommentContainer: UIView = {
        ...
        image.anchor(top: view.topAnchor ,left: view.leftAnchor,paddingTop: 10 ,paddingLeft: 15)
    ...
    override init(frame: CGRect) {
        ...
        contentsLabel.anchor(top: topAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 10, paddingLeft: 15, paddingRight: 10)
        
        addSubview(topSeperateLine)
        topSeperateLine.anchor(top: contentsLabel.bottomAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 60, height: 1)
        
     
        addSubview(numberCuriousAndCommentContainer)
        numberCuriousAndCommentContainer.anchor(left: leftAnchor, bottom: bottomAnchor, paddingBottom: 20)
        numberCuriousAndCommentContainer.setDimension(width: 120, height: 30)
